            ...
            <section ref={container} id="offer-cards">
                <div className="w-[85%] mx-auto py-[10%] tablet:py-[15%]">
                    ...
                    <div className="grid grid-cols-3 gap-6 w-[85%] h-full ml-auto tablet:grid-cols-2 tablet:w-full mobile:grid-cols-1">
                        <Card text="Content Marketing" />
                        <Card text="Search Engine Optimization" />
                        ...
                        <div className="h-[10vw] tablet:h-[15vh] mobile:h-[20vh] rounded-2xl overflow-hidden shadow-lg group fadeup">
                            <Image 
                                ...
                                src='/assets/service-detail/marketing/marketing4.webp'
                        ...
                        <Card text="Social Media Management" />

                        <div className="h-[10vw] tablet:h-[15vh] mobile:h-[20vh] rounded-2xl overflow-hidden shadow-lg group fadeup" >
                            <Image 
                                className="w-full h-full group-hover:scale-105 duration-500 group-hover:saturate-0"
                                src='/assets/service-detail/marketing/marketing5.webp'
                                alt='our service image'
                                priority={false}
                                width={450}
                                height={190}
                        ...
                        <Card text="Influencer Partnerships" />
                        <Card text="Community Building" />
                        <Card text="PR and Media Outreach" />
                        <Card text="Reputation Management" />
                        <Card text="Analytics and Reporting" />
                    </div>
                </div>
            </section>
        </>
