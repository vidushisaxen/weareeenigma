                    ...
                    <div className="grid grid-cols-3 gap-6 w-[85%] h-full ml-auto tablet:grid-cols-2 tablet:w-full mobile:grid-cols-1">
                        ...
                        <div className="h-[10vw] tablet:h-[15vh] mobile:h-[20vh] rounded-2xl overflow-hidden shadow-lg group fadeup">
                            <Image 
                                ...
                                src='/assets/service-detail/technology/technology4.webp'
                        ...
                        <Card text="Web Application Development" />

                        <div className="h-[10vw] tablet:h-[15vh] mobile:h-[20vh] rounded-2xl overflow-hidden shadow-lg group fadeup" >
                            <Image 
                                className="w-full h-full group-hover:scale-105 duration-500 group-hover:saturate-0"
                                src='/assets/service-detail/technology/technology5.webp'
                                alt='our service image'
                                priority={false}
                                width={450}
                                height={190}
                        ...
                        <Card text="E-commerce Solutions" />
                        <Card text="DevOps Services" />
                        <Card text="Technology Consulting" />
                        <Card text="Quality Assurance and Testing" />
                        <Card text="Continuous Support and Maintenance" />
                    </div>
                </div>
            </section>
        </>
